...
<template>
    <div class="recycle">
        ...
        <div :class="['listContent','listType_'+listType]">
            <ul>
                <file-list-detail v-for="(item,index) in list" :key="index" :item="item" :dir="dir" :listType="listType" :from="'recycle'"></file-list-detail>
    ...
    export default {
        ...
        methods      : {
            ...
            goto          : function (type, targetId) {
                ...
                let targetRoute = {path: '/recycle', query: Object.assign(query, {page: 1})};
