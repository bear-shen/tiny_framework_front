...
-->
<template>
    <div :class="['favourite',refreshStamp]">
        ...
        <ul :class="['listContent','listType_'+listType]">
            <file-list-detail
                ...
                :key="index" :item="item" :dir="dir" :from="'favourite'"
            ></file-list-detail>
            <file-list-text
...
export default {
    ...
    methods      : {
        ...
        query: function (query, page) {
            ...
            query = Object.assign({page, type: this.type}, query)
            // console.info(Popup);
            // Popup.show();
            ...
            return new Promise((resolve, reject) => {
                helper.query(
                    ...
                    console.warn(data);
                    return resolve({list: data.list, dir: data.dir, navi: data.navi, query});
                });
            });
        },
        /**
        ...
        goto: function (type, targetId) {
            ...
            // console.warn(JSON.stringify(query));
            let targetRoute = {path: '/favourite', query: Object.assign(query, {page: 1})};
